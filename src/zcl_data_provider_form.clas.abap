CLASS zcl_data_provider_form DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_data_provider_form IMPLEMENTATION.
...
*    If no data is needed
    ...
    DATA lt_ret_data TYPE TABLE OF zi_header_form.
